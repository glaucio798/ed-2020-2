/* 
    ...
    Solução de: Gláucio Martins Lima
*/
...
armazem::armazem(armazem &teste){
	quantidadeDeItens = teste.quantidadeDeItens;
	capacidadeMaxima = teste.capacidadeMaxima;
	listaDeItens = new item[capacidadeMaxima];
	copy(teste.listaDeItens, teste.listaDeItens + capacidadeMaxima, listaDeItens);
...
void armazem::redimensionarCapacidade() {
	item* novaLista = new item[capacidadeMaxima];
	copy(listaDeItens, listaDeItens + capacidadeMaxima, novaLista);
    
	int novaCapacidade = ceil(capacidadeMaxima * 1.2);
    
	delete [] listaDeItens;
	listaDeItens = new item[novaCapacidade];
	
	copy(novaLista, novaLista + capacidadeMaxima, listaDeItens);
